...
<body>
    <div class="Contenedor">
        <header>
            ...
            <div class="menu">
                <nav>
                    <ul>
                        <li class="menu_li_Active"><a href="#">Navbar</a></li>
                        <li><a href="./posts.html">Publicaciones</a></li>
                        <li><a href="./posts.html">Contenido Didactico</a></li>
    ...
    <div class="Footer">
        <footer>
            <p>Design made by @Aurora_Code in 2021</p>
        </footer>
    </div>
