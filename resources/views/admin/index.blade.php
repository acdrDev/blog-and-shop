  ...
  <form class="card" enctype="multipart/form-data" method="POST" action="{{ route('site_init', $data->id) }}">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input value="{{ $data->first_section_title }}" id="first-title" class="form-control mb-2" name="first_section_title"/>
        ...
        <textarea id="first-description" class="form-control" style="min-height: 200px;" name="first_description">{{ $data->first_description }}</textarea>
      </div>

      <h4 class="w-100 mb-2">Segunda Sección</h4>
      <div class="form-group">
        <label for="second-title" class="form-label">Titulo</label>
        <input value="{{ $data->second_section_title }}" class="form-control mb-2" name="second_section_title" id="second-title"/>
        <label for="second-description" class="form-label">Contenido</label>
        <textarea class="form-control" style="min-height: 200px;" name="second_description">{{ $data->second_description }}</textarea>
      </div>
      ...
      <div class="form-group row w-100">
        ...
        <div class="input-group mb-2">
          ...
          <input value="{{ $data->twitter }}" class="form-control border border-secondary" placeholder="https://twitter.com/aurora_code" type="text" name="twitter" />
        </div>
        ...
        <div class="input-group mb-2">
          ...
          <input value="{{ $data->facebook }}" class="form-control border border-secondary" placeholder="https://www.facebook.com/aurora_code" type="text" name="facebook" />
        </div>
        ...
        <div class="input-group mb-2">
          ...
          <input value="{{ $data->whatsapp }}" class="form-control border border-secondary" placeholder="Enlace a whatsapp" type="text" name="whatsapp" />
        </div>
        </div>
