...
<!------------------------------Creacion de Las Secciones------------------------------> 
  ...
  <section class="section">
              <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit et est magnam qui sequi saepe molestias, sit adipisci reiciendis magni tempora, repellendus libero placeat, iure alias quos laudantium aliquid illo?</p>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/petel/Work/blog-and-shop/resources/views/index.blade.php ENDPATH**/ ?>